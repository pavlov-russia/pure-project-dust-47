...
const Index = () => {
  ...
  return <div className="min-h-screen w-full fixed inset-0 bg-white">
      ...
      <Header />
      <ChecklistPopup isOpen={isPopupOpen} onClose={() => {
        setIsPopupOpen(false);
        setFreezeCountdown(true);
      }} />
          ...
          <div className="max-w-lg mx-auto relative">
            ...
            <div className="flex-1 flex flex-col justify-center">
              ...
              <p className="text-sm md:text-base mb-6 leading-relaxed text-white/90 max-w-md mx-auto">
                У вас есть менее <AnimatedCountdown active={!hasCountdownRun} frozen={freezeCountdown} onComplete={() => {
      ...
      <section className="py-8 bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <svg width="1486" height="1080" viewBox="0 0 1486 1080" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-0 right-0 w-full h-full object-cover" style={{
      ...
      <section className="pt-2 pb-8 bg-gradient-to-b from-[#7460f1] to-[#563AF0]">
        <div className="container mx-auto px-6 max-w-full">
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-white/70 italic mt-2 mx-auto" style={{
              marginLeft: '-18px',
              marginRight: '-18px'
            }}>
          ...
          <SectionCard className="bg-[rgba(86,58,240,0.08)] border-[rgba(86,58,240,0.2)]">
            <div className="text-center space-y-8">
              ...
              <div className="space-y-6 max-w-4xl mx-auto text-left">
                {["Всё под ключ – от оформленного ТГ-канала с контент-стратегией до разработки web-app", "Продуманная и прозрачная воронка от первого клика по рекламному объявлению до денег в кассе", "WOW-эффект и яркое впечатление", "Увеличение лояльности и доверия, эмоциональная связь", "Гибкий функционал с внедрением ИИ – под ваши цели, задачи и потребности"].map((text, index) => <div key={index} className="flex items-start space-x-4">
                    {/* Curved Checkmark */}
      ...
      {/* Consultation Form */}
      <div className="-mt-20 pb-0 bg-transparent">
        <ConsultationForm />
      </div>
      </div>
    </div>;
