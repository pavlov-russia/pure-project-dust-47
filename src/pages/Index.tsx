        ...
        <div className="container mx-auto px-6 max-w-full">
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center mt-2">
              <div 
                className="spoiler-container inline-block px-2 py-1 rounded cursor-pointer relative"
                onClick={(e) => {
                  const spoiler = e.currentTarget.querySelector('.spoiler-content');
                  const dots = e.currentTarget.querySelector('.spoiler-dots');
                  if (spoiler && dots) {
              ...
              >
                ...
                <span className="spoiler-content text-sm italic">
