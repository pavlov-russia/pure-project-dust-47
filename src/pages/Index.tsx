        ...
        <div className="container mx-auto px-2 max-w-full">
          <div className="w-full relative">
            <div className="p-8 md:p-12 relative z-10">
              ...
              <div className="w-full bg-white/15 rounded-2xl px-6 py-6 mb-8 border border-white/20 animate-pulse shadow-[0_0_30px_rgba(255,255,255,0.3)] transition-all duration-1000">
