        ...
        <div className="container mx-auto px-6 max-w-full">
          <div className="max-w-lg mx-auto relative">
            <div className="p-8 md:p-12 relative z-10">
              ...
              <div className="bg-white/15 rounded-2xl p-8 md:p-12 mb-8 border border-white/20 animate-pulse shadow-[0_0_30px_rgba(255,255,255,0.3)] transition-all duration-1000">
