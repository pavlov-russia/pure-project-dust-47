...
const Index = () => {
  ...
  return (
    <div className="min-h-screen" style={{background: 'linear-gradient(135deg, #7962f4 0%, #7e68f5 20%, #8370f6 40%, #8776f7 60%, #8b7cf8 80%, #7962f4 100%)', backdropFilter: 'blur(20px)'}}>
      <Header />
      <ChecklistPopup />
