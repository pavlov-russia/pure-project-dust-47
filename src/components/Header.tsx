    ...
    <header className="fixed top-0 left-0 right-0 z-50 animate-fade-in">
      ...
      >
        ...
        <div className="flex items-center relative z-10">
          <img 
            src="/lovable-uploads/78b8e067-7930-479e-a187-1c282db327da.png" 
            alt="TapBlog" 
            className="h-6 md:h-8 w-auto drop-shadow-sm" 
          />
          <p className="text-xs text-destructive font-medium ml-4 max-w-[200px] leading-tight">
            Насть, текста и ссылки в разработке, на них толком не смотрим :)
          </p>
        </div>
        
        {/* CTA Button - показывается только после скролла */}
