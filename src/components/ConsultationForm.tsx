              ...
              <div className="text-center mb-8">
                ...
                <div className="relative mx-auto w-20 h-20 mb-6">
                  <div className="relative z-10 w-full h-full flex items-center justify-center">
                    <svg width="70" height="70" viewBox="0 0 151 151" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-lg">
                      <defs>
                      ...
                      <g clipPath="url(#clipCircle)">
                        <circle cx="75.5" cy="75.5" r="75" fill="#563AF0"/>
                        <path fillRule="evenodd" clipRule="evenodd"
                              ...
                              fill="white"/>
                        <circle cx="75.5" cy="135" r="40" fill="white"/>
                      </g>
                    </svg>
                  </div>
                </div>
