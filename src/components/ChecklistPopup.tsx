...
const ChecklistPopup = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogPortal>
        <DialogOverlay 
          className="fixed inset-0 z-50 bg-black/40 transition-[backdrop-filter,opacity] duration-[800ms] ease-[cubic-bezier(0.25,0.1,0.25,1)] data-[state=open]:backdrop-blur-md data-[state=closed]:backdrop-blur-0 data-[state=open]:opacity-100 data-[state=closed]:opacity-0"
        />
        <DialogContent 
